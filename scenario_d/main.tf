...
########## Scenario D: Single Foundry Account with Multiple Projects    ##########
########## Shared Storage, AI Search and CosmosDB across all projects   ##########
...
## =============================================
## AI FOUNDRY ACCOUNT (SINGLE, SHARED)
## =============================================
...
## =============================================
## AI FOUNDRY PROJECTS (ONE PER TEAM)
## =============================================
...
resource "azapi_resource" "storage_connection" {
  ...
  name      = "storage-connection-${each.key}"
...
resource "azapi_resource" "search_connection" {
  for_each  = var.projects
  type      = "Microsoft.CognitiveServices/accounts/projects/connections@2025-06-01"
  name      = "search-connection-${each.key}"
  parent_id = azapi_resource.ai_project[each.key].id
...
resource "azapi_resource" "cosmosdb_connection" {
  for_each  = var.projects
  type      = "Microsoft.CognitiveServices/accounts/projects/connections@2025-06-01"
  name      = "cosmosdb-connection-${each.key}"
  parent_id = azapi_resource.ai_project[each.key].id
...
## =============================================
## CAPABILITY HOSTS (ONE PER PROJECT)
## =============================================
...
## =============================================
## MODEL DEPLOYMENT (SHARED ACROSS PROJECTS)
## =============================================
